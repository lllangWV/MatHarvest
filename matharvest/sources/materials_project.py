...
def download_molecules(save_dir, chunk_size=10000):
    ...
    with MPRester(MP_API_KEY) as mpr:
        summary_docs = mpr.molecules.summary._search(all_fields=True,fields=['molecule_id'])
...
if __name__=='__main__':
    ...
    download_molecules(save_dir=os.path.join(molecules_dir, endpoint), chunk_size=10000)
